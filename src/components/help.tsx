  ...
  return (
    <>
      <Container className="font-montserrat container mt-5">
        <h2 className="fw-bold fs-2 text-center pt-5 flex-column align-items-center gap-3">{t.fullcard.helptittle}</h2>
        ...
        className="pb-5 pt-5">
          {helpcards.map((card, index) => (
            <Carousel.Item key={index} className="p-2 pt-5">
              <div className="cards-mobile mx-3" style={{ border: '10px', paddingBottom: '20px', height: '152px' }}>
                <Image src={card.icon} style={{ width: '15%', marginTop: '-30px', marginBottom: '20px' }} className="card-img-top" alt="" />
