    ...
    <div className="font-montserrat">
      <div className="container">
        ...
        <p className="container">
          ...
          <strong className="me-1">Services:</strong> Smart Fleet Funding Corp.
          ...
          businesses in North America that meet Smart Fleet Funding Corp.{"'"}s
          credit and underwriting criteria. <br />
          ...
          Services. By uploading content, you grant Smart Fleet Funding Corp. a
          ...
          Smart Fleet Funding Corp. may terminate this Agreement for any reason,
          with or without notice. You may terminate this Agreement by ceasing to
          use the Services.
          <h3 className="mt-4 fw-600">Modifications to Terms of Use</h3>
          Smart Fleet Funding Corp. reserves the right to modify these Terms at
          ...
          questions about these Terms, please contact Smart Fleet Funding Corp.
          at info@smartfleetfunding.com
          <br />
        </p>
      </div>
    </div>
