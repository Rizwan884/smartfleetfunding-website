    ...
    <div className="font-montserrat">
      <div className="container">
        ...
        <p className="container">
          Welcome to the Smart Fleet Funding website www.smartfleetfunding.com
          By using the Website or our services (Fullfact, FES Pay, Fuel Card,
          Freight Broker Program), as you agree to be bound by these Terms of
          Use. If you do not agree to all the Terms, do not use the Website or
          Services.
          <br />
          <br />
          ...
          Program.
          <br />
          <strong className="me-1">Invoice:</strong> A bill issued by a User to
          their customer for services rendered. By using the Website or
          ...
          <ul className="mt-1">
            ...
            <li>
              Promptly notify Smart Fleet Funding of any changes to your
              business information.
            </li>
          </ul>
          <h3 className="mt-4 fw-600">Fees and Charges</h3>
          Smart Fleet Funding charges fees for its Services, including factoring
          rates and any additional administrative fees. The specific fees
          applicable to your business will be disclosed in a separate agreement
          before you enroll in the Services. You are responsible for the timely
          payment of all fees.
          <h3 className="mt-4 fw-600">User Content</h3>
          You may be required to upload invoices or other documents to use the
          Services. By uploading content, you grant Smart Fleet Funding a
          non-exclusive, irrevocable license to use, reproduce, modify, and
          distribute such content for the purpose of providing the Services.
          <h3 className="mt-4 fw-600">Disclaimers and Warranties</h3>
          Smart fleet funding makes no warranties, express or implied, regarding
          the services, including any warranty of merchantability, fitness for a
          particular purpose, or accuracy of data.
          <h3 className="mt-4 fw-600">Limitation of Liability</h3>
          Smart fleet funding shall not be liable for any indirect, incidental,
          ...
          Smart Fleet Funding may terminate this Agreement for any reason, with
          or without notice. You may terminate this Agreement by ceasing to use
          the Services.
          <h3 className="mt-4 fw-600">Modifications to Terms of Use</h3>
          Smart Fleet Funding reserves the right to modify these Terms at any
          time. We will notify you of any material changes by posting the
          revised Terms on the Website. Your continued use of the Website or
          Services constitutes your acceptance of the revised Terms.
          <h3 className="mt-4 fw-600">Governing Law and Dispute Resolution</h3>
          These Terms shall be governed by and construed in accordance with the
          laws. Any dispute arising out of or relating to the Terms will be
          ...
          questions about these Terms, please contact Smart Fleet Funding at
