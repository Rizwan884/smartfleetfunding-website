      ...
      <div className="font-montserrat">
        <div className="container">
          ...
          <p className="container">
            Our Privacy Policy was last updated and posted on January 6, 2021.
            ...
            owned and operated by Smart Fleet Funding Corp. Any capitalized
            terms not defined in our Privacy Policy, have the meaning as
            specified in our Terms of Service.
            <br />
            <br />
            Your privacy is very important to us. Accordingly, we have developed
            this Policy for you to understand how we collect, use, communicate
            and disclose and make use of personal information. We use your
            Personal Information only for providing and improving the website.
            ...
            https://smartfleetfunding.com. The following outlines our privacy
            policy.
            <ul className="mt-3">
              <li>
            ...
            information, and how you can limit our sharing of your information.
            We utilize the Personal Data you offer in a way that is consistent
            with this Personal privacy Policy. If you provide Personal Data for
            a particular reason, we could make use of the Personal Data in
            ...
            monitor your use of such services. Smart Fleet Funding Corp. may
            also utilize your Personal Data and various other personally
            non-identifiable info gathered through the Website to assist us with
            improving the material and functionality of the Website, to
            comprehend our users much better, and to improve our services. You
            will see terms in our Privacy Policy that are capitalized. These
            terms have meanings as described in the Definitions section below.
            ...
            available information that is shared between you and others. <br />
            {'"Personally Identifiable Information"'} is non-public information
            that is personally identifiable to you and obtained in order for us
            to provide you, our website. Personally Identifiable Information may
            include information such as your name, email address, and other
            related information that you provide to us or that we obtain about
            you.
            <h3 className="mt-4 fw-600">Information We Collect</h3>
            ...
            <h3 className="mt-4 fw-600">Computer Information Collected</h3>
            ...
            <ul>
              ...
              <li className="mt-4 fw-600">
                <h4 className="mt-4 fw-600">Geographical Information</h4>
              </li>
              ...
              <li>
                <h4 className="mt-4 fw-600">Automatic Information</h4>
                ...
                of the website to which you
                {"'"}re headed when you leave our website. This information also
                includes the IP address of your computer/proxy server that you
                use to access the Internet, your Internet Website provider name,
                web browser type, type of mobile device, and computer operating
                system. We use all this information to analyze trends among our
                Users to help improve our website.
              </li>
              <li>
                <h4 className="mt-4 fw-600">Log Data</h4>
                Like many Website operators, we collect information that your
                browser sends whenever you visit our website ({'"Log Data"'}).
                This Log Data may include information such as your computer{"'"}
                s Internet Protocol ({'"IP"'}) address, browser type, browser
                version, the pages of our website that you visit, the time and
                date of your visit, the time spent on those pages and other
                statistics.
              </li>
            </ul>
            Under the Child{"'"}s Online Privacy Security Act, no Website
            operator can require, as a condition to involvement in an activity,
            that a child younger than 13 years of age divulge more details than
            is reasonably required. Smart Fleet Funding Corp. abides by this
            demand. Smart Fleet Funding Corp. just collects information
            willingly offered; no information is gathered passively. children
            under 13 can submit only their email address when sending us an
            email in our {'Contact Us'}
            ...
            deletes the email address. In case Smart Fleet Funding Corp.
            collects and maintains personal information relating to a child
            under 13, the parent may send out an email to us to review, alter
            and/or erase such info as well as to decline to enable any
            additional collection or use of the child{"'"}s information.
            <br />
            <h3 className="mt-4 fw-600">How We Use Your Information</h3>
            We use the information we receive from you as follows:
            <ul>
              <li>
                <h4 className="mt-4 fw-600">Customizing Our Website</h4>
              ...
              <li>
                <h4 className="mt-4 fw-600">Data Aggregation</h4>
            ...
            identifiable information used for functions when we ask you for this
            detail. When you register for the website, if you do not want to
            receive any additional material or notifications from us, you can
            show your preference on our registration form.
            <br />
            <h3 className="mt-4 fw-600">Links to Other Websites</h3>
            ...
            information.
            <h3 className="mt-4 fw-600">Security</h3>
            ...
            <h3 className="mt-4 fw-600">Privacy Policy Updates</h3>
            ...
            is at our sole discretion. We will also change the{' '}
            {'"Last Updated"'} date at the beginning of this Privacy Policy. Any
            changes we make to our Privacy Policy are effective as of this Last
            ...
            principles to ensure that the confidentiality of personal
